...
export const metadata = {
  title: "Palmer Burlington Bathroom Renovation | EPF Pro Services",
  description: "Keyword page for bathroom renovation in Palmer, Burlington. Unique local process notes, scope guidance, and renovation FAQ.",
  alternates: { canonical: "/locations/burlington-palmer-bathroom-renovation/" },
...
const highlights = [
  {
    "title": "Scope Clarity",
    "text": "We define deliverables for bathroom renovation in Palmer, Burlington before construction starts, so decisions stay controlled."
  },
  {
    "title": "Site Protection",
    "text": "Dust control, floor protection, and daily cleanup are standard on every Palmer, Burlington project."
  },
  {
...
const faqItems = [
  {
    "q": "How is bathroom renovation priced in Palmer, Burlington?",
  ...
  {
    "q": "How long does bathroom renovation take in Palmer, Burlington?",
...
const gallery = [
  {
    "src": "/home/2.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 1"
  },
  {
    "src": "/home/3.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 2"
  },
  {
    "src": "/home/4.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 3"
  },
  {
    "src": "/home/5.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 4"
  },
  {
    "src": "/home/6.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 5"
  },
  {
    "src": "/home/7.webp",
    "alt": "Bathroom Renovation project in Palmer-Burlington - photo 6"
  }
];
const keywordLinks = [
  {
