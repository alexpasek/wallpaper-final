...
export const metadata = {
  title: "Tansley Burlington Bathroom Renovation | EPF Pro Services",
  description: "Keyword page for bathroom renovation in Tansley, Burlington. Unique local process notes, scope guidance, and renovation FAQ.",
  alternates: { canonical: "/locations/burlington-tansley-bathroom-renovation/" },
...
const highlights = [
  {
    "title": "Scope Clarity",
    "text": "We define deliverables for bathroom renovation in Tansley, Burlington before construction starts, so decisions stay controlled."
  },
  {
    "title": "Site Protection",
    "text": "Dust control, floor protection, and daily cleanup are standard on every Tansley, Burlington project."
  },
  {
...
const faqItems = [
  {
    "q": "How is bathroom renovation priced in Tansley, Burlington?",
  ...
  {
    "q": "How long does bathroom renovation take in Tansley, Burlington?",
...
const gallery = [
  {
    "src": "/home/3.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 1"
  },
  {
    "src": "/home/4.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 2"
  },
  {
    "src": "/home/5.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 3"
  },
  {
    "src": "/home/6.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 4"
  },
  {
    "src": "/home/7.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 5"
  },
  {
    "src": "/home/8.webp",
    "alt": "Bathroom Renovation project in Tansley-Burlington - photo 6"
  }
];
const keywordLinks = [
  {
