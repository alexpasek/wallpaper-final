...
export const metadata = {
  title: "Headon Forest Burlington Bathroom Renovation | EPF Pro Services",
  description: "Keyword page for bathroom renovation in Headon Forest, Burlington. Unique local process notes, scope guidance, and renovation FAQ.",
  alternates: { canonical: "/locations/burlington-headon-forest-bathroom-renovation/" },
...
const highlights = [
  {
    "title": "Scope Clarity",
    "text": "We define deliverables for bathroom renovation in Headon Forest, Burlington before construction starts, so decisions stay controlled."
  },
  {
    "title": "Site Protection",
    "text": "Dust control, floor protection, and daily cleanup are standard on every Headon Forest, Burlington project."
  },
  {
...
const faqItems = [
  {
    "q": "How is bathroom renovation priced in Headon Forest, Burlington?",
  ...
  {
    "q": "How long does bathroom renovation take in Headon Forest, Burlington?",
...
const gallery = [
  {
    "src": "/home/3.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 1"
  },
  {
    "src": "/home/4.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 2"
  },
  {
    "src": "/home/5.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 3"
  },
  {
    "src": "/home/6.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 4"
  },
  {
    "src": "/home/7.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 5"
  },
  {
    "src": "/home/8.webp",
    "alt": "Bathroom Renovation project in Headon Forest-Burlington - photo 6"
  }
];
const keywordLinks = [
  {
