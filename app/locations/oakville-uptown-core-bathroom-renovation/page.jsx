...
export const metadata = {
  title: "Uptown Core Oakville Bathroom Renovation | EPF Pro Services",
  description: "Keyword page for bathroom renovation in Uptown Core, Oakville. Unique local process notes, scope guidance, and renovation FAQ.",
  alternates: { canonical: "/locations/oakville-uptown-core-bathroom-renovation/" },
...
const highlights = [
  {
    "title": "Scope Clarity",
    "text": "We define deliverables for bathroom renovation in Uptown Core, Oakville before construction starts, so decisions stay controlled."
  },
  {
    "title": "Site Protection",
    "text": "Dust control, floor protection, and daily cleanup are standard on every Uptown Core, Oakville project."
  },
  {
...
const faqItems = [
  {
    "q": "How is bathroom renovation priced in Uptown Core, Oakville?",
  ...
  {
    "q": "How long does bathroom renovation take in Uptown Core, Oakville?",
...
const gallery = [
  {
    "src": "/home/2.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 1"
  },
  {
    "src": "/home/3.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 2"
  },
  {
    "src": "/home/4.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 3"
  },
  {
    "src": "/home/5.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 4"
  },
  {
    "src": "/home/6.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 5"
  },
  {
    "src": "/home/7.webp",
    "alt": "Bathroom Renovation project in Uptown Core-Oakville - photo 6"
  }
];
const keywordLinks = [
  {
